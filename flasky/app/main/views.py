...
from flask import Flask,render_template,session,redirect,url_for,flash,current_app,abort,request,make_response
...
@main.route('/flasky',methods=['GET','POST'])
def flasky():
...
def edit_profile_admin(id):
    ...
    if form.validate_on_submit():
        ...
        user.confirmd = form.confirmed.data
